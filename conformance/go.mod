module github.com/TrueWatch/beak-agent-channel-teams/conformance

go 1.23

replace github.com/TrueWatch/beak-agent-channel-teams => ../
...
require (
	github.com/TrueWatch/beak-agent-channel-teams v0.0.0-00010101000000-000000000000
